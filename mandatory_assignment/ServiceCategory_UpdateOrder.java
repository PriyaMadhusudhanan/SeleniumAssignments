...
public class ServiceCategory_UpdateOrder {
	...
	public static void main(String[] args) {
		...
		//Switch to Frame
		driver.switchTo().frame("gsft_main");
		driver.findElement(By.xpath("//span[@class='input-group-addon input-group-select']/following-sibling::input")).sendKeys("REQ0010036",Keys.ENTER);
		...
		requestState.selectByVisibleText("Approved");
